...
def train_model(model, dataloaders, criterion, optimizer, num_epochs=25, weights_name='weight_save', is_inception=False):
    print('====================== New Run =======================',file=open("output_SE.txt", "a"))
    '''
    ...
    for epoch in range(num_epochs):
        ...
        print('Epoch {}/{}'.format(epoch, num_epochs - 1), file=open("output_SE.txt", "a"))
        print('-' * 10, file=open("output_SE.txt", "a"))
        ...
        for phase in ['train', 'val']:
            ...
            print('{} Loss: {:.4f} Acc: {:.4f}'.format(phase, epoch_loss, epoch_acc), file=open("output_SE.txt", "a"))
            print(f"Epoch time taken: {elapsed_epoch}", file=open("output_SE.txt", "a"))
...
best_model, val_acc_history, loss_acc_history = train_model(resnet, dataloaders, criterion, optimizer, 25, 'SEresnet18_bestsofar')

#%%
import numpy as np
np.save('history/val_acc_history_SEresnet18_25.npy',np.array(val_acc_history))
np.save('history/loss_acc_history_SEresnet18_25.npy',np.array(loss_acc_history))
# %%
#import numpy as np
